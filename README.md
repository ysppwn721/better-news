...
**📱 Android App 下载**：<https://github.com/ysppwn721/better-news/releases/download/v1.2/app-release.apk>

> 安装提示：若之前装过旧版，直接覆盖安装即可（版本号已递增到 1.2）。
> 首次打开会自动抓取全部 102 个信源，约需 **1~3 分钟**，界面顶部会显示抓取进度。
> 抓完后列表自动出现内容（**无需手动刷新**）。
>
