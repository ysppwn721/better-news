...
**📱 Android App 下载**：<https://github.com/ysppwn721/better-news/releases/download/v1.3/app-release.apk>

> 安装提示：若之前装过旧版，直接覆盖安装即可（版本号已递增到 1.3）。
> 首次打开会自动抓取全部 102 个信源，界面顶部会显示抓取进度。
...
|---|---|---|---|---|
| **Android App**（推荐） | ❌ | ❌ | 打开即抓 | 102 个信源约 1~3 分钟 |
...
> 因此每个栏目都按发布时间翻页到 6 个月前为止（最多 16 页）。
